...
// 9) Документация
// 16) Фикс моргания окна, которое стримится
// 17) Фикс когда у процесса несколько окон
// 18) (забил)GPU accelertation
...
//+11) Скринить именно окно, а не экран по местоположению окна
//+12) Ограничить область для выделения, чтобы нельзя было мышкой выйти за них
//+13) Exception при изменении имени окна
//+14)Пофиксить когда окно меньше выделенной области
//+15)Выделение области приложения
//--------------------------
// 1*) Сохранение видео
